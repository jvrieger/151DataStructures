...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  public static final int LOWER_CAP = 999983; //LOWER_CAP < capacity and is prime
  ...
  protected int hashValue2(K key) {
      return (int) (LOWER_CAP - key.hashCode() % LOWER_CAP); //LOWER_CAP < capacity and is prime, d(k)
  }
